...
const ControlsMobile = () => {
    return (
        <nav className="bottom-0 inset-x-0 flex justify-between mx-auto fixed md:hidden bg-neutral-content shadow-inner">
            ...
            <div className="dropdown dropdown-top">
                ...
                <div className="overflow-y-auto shadow-2xl top-px dropdown-content rounded-box bg-base-100 text-base-content">
                    ...
                    <ul className="menu compact shadow-2xl text-2xl">
                        <li><a tabIndex="0" className="font-mono">mono</a></li>
                        <li><a tabIndex="0" className="font-regular">regular</a></li>
                        <li><a tabIndex="0" className="font-serif">serif</a></li>
                    </ul >
                </div >
            </div >
            <div className="dropdown dropdown-top">
